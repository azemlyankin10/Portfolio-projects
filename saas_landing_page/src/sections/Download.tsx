                ...
                <div className="container">
                    <div className="flex items-center">
                        <div className="relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100">
                            ...
                            <p className='body-1 mb-10 max-w-md'>Try it now for free on ios, Android, Web - whatever your flavor, we've got you covered.</p>
                        ...
                        <div className="mb-10 max-md:hidden">
                            <div className="download_preview-before download_preview-after relative w-[955px] border-2 border-s5 p-6">
