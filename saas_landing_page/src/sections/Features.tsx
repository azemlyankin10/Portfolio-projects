                ...
                <div className="container">
                    <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
                        { features.map(({id, icon, title, text, button, caption}) => (
                            <div key={id} className='relative z-2 md:px-10 px-6 pb-5 flex-50 max-md:g7 max-md:border-2 max-md:border-s3 max-md:rounded-3xl max-md:flex-320'>
                                ...
                                <p className="max-w-400 mb-7 h3 max-md:mb-6 max-md:h5">{title}</p>
